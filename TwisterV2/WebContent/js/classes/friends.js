...
(function() {
    ...
    env.friend.Friend.prototype.HTML = function() {
		 return getHTML(this)
  	}
...
(function() {
   ...
   //if (typeof(this.m)=="object")
	...
	env.friend.Friends.prototype.HTML = function() {
		return getHTML(this);
  	}
