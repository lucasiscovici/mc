...
class test {
	public static void main(String[] args) throws NumberFormatException, ClassNotFoundException, IOException, JSONException, LucasException, SQLException {
		...
		new SAddComment(Dico.toP("text","dd","id_post","58a5f78e8d6a81032afe9570","key","6560627d-e674-4e97-8f0e-04761b9e58d7")).print();
	...
	//	new SListUsers(Dico.toP("key","46e5a834-1f85-4853-a176-ffa0ca44d80e")).print();
		//new SAddFriend(Dico.toP("key","14945d4d-d77f-4c18-94f6-69839b297a77","id_friend","4")).print();
		//new SListFriends(Dico.toP("key","59137d91-07ba-4f00-aa19-682f4af6a3a9","id","4")).print();
		//new SRemoveFriend(Dico.toP("key","14945d4d-d77f-4c18-94f6-69839b297a77","id_friend","1")).print();
		//new SListPosts(Dico.toP("key","1b9233b0-4d5a-4201-8280-4f0efa52c41a","id","58a5cf838d6a817842b7f97d")).print(); 
